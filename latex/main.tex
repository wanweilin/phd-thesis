...
% ======== 宏包 ========
% 注意：fduthesis 已加载 amsmath + unicode-math，不要再加载 amssymb/amsfonts/bm
...
% ======== 自定义命令 ========
% 通用（unicode-math 下用 \symbf 替代 \bm）
...
% ======== 攻读博士学位期间发表的论文 ========
{
\chapter*{攻读博士学位期间发表的论文}
\addcontentsline{toc}{chapter}{攻读博士学位期间发表的论文}
\markboth{攻读博士学位期间发表的论文}{攻读博士学位期间发表的论文}

\noindent\textbf{会议论文}

\begin{enumerate}
  \item \underline{Weilin Wan}, Weizhong Zhang, Cheng Jin. Computational Budget Should Be Considered in Data Selection. \textit{Advances in Neural Information Processing Systems (NeurIPS)}, 2025.

  \item \underline{Weilin Wan}, Fan Yi, Weizhong Zhang, Quan Zhou, Cheng Jin. Explore and Establish Synergistic Effects Between Weight Pruning and Coreset Selection in Neural Network Training. \textit{Proceedings of the AAAI Conference on Artificial Intelligence (AAAI)}, 2026.

  \item Zhikang Xie, \underline{Weilin Wan}, Peizhu Gong, Weizhong Zhang, Cheng Jin. Advanced Black-Box Tuning of Large Language Models with Limited API Calls. \textit{Proceedings of the AAAI Conference on Artificial Intelligence (AAAI)}, 2026.

  \item \underline{Weilin Wan}, Weizhong Zhang, Cheng Jin. Pose-Motion Video Anomaly Detection via Memory-Augmented Reconstruction and Conditional Variational Prediction. \textit{IEEE International Conference on Multimedia and Expo (ICME)}, 2023.
\end{enumerate}
...
\begin{enumerate}
  \setcounter{enumi}{4}
  \item \underline{Weilin Wan}, Weizhong Zhang, Quan Zhou, Fan Yi, Cheng Jin. Out-of-Distribution Detection Using Neural Activation Prior. \textit{arXiv preprint}, 2024.

  \item \underline{Weilin Wan}, Jingtao Han, Weizhong Zhang, Cheng Jin. Holistic Scaling Laws for Optimal Mixture-of-Experts Architecture Optimization. \textit{arXiv preprint}, 2026.
\end{enumerate}
}
